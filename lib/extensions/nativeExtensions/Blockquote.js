...
function (_AbstractExtension) {
  _inherits(Blockquote, _AbstractExtension);

  function Blockquote(options) {
    _classCallCheck(this, Blockquote);

    return _possibleConstructorReturn(this, _getPrototypeOf(Blockquote).call(this, options, BlockquoteOriginal));
  }
    ...
    get: function get() {
      ...
      return [{
        render: new ExtensionActionRenderBtn({
          ...
          /* md */
          , new VuetifyIcon('format_quote')), _defineProperty(_icons, "fa"
          /* fa */
          , new VuetifyIcon('fas fa-quote-right')), _defineProperty(_icons, "mdi"
          /* mdi */
          , new VuetifyIcon('mdi-format-quote-close')), _defineProperty(_icons, "mdiSvg"
          /* mdiSvg */
          , new VuetifyIcon('M14,17H17L19,13V7H13V13H16M6,17H9L11,13V7H5V13H8L6,17Z')), _icons),
