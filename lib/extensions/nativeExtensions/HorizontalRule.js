...
function (_AbstractExtension) {
  _inherits(HorizontalRule, _AbstractExtension);

  function HorizontalRule(options) {
    _classCallCheck(this, HorizontalRule);

    return _possibleConstructorReturn(this, _getPrototypeOf(HorizontalRule).call(this, options, HorizontalRuleOriginal));
  }
    ...
    get: function get() {
      ...
      return [{
        render: new ExtensionActionRenderBtn({
          ...
          /* md */
          , new TextIcon('—')), _defineProperty(_icons, "fa"
          /* fa */
          , new VuetifyIcon('fas fa-minus')), _defineProperty(_icons, "mdi"
          /* mdi */
          , new VuetifyIcon('mdi-minus')), _defineProperty(_icons, "mdiSvg"
          /* mdiSvg */
          , new VuetifyIcon('M19,13H5V11H19V13Z')), _icons),
